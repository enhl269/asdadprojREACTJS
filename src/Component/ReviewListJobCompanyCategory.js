...
import DataService from "../Services/WebUserReviewService";
import { Link } from "react-router-dom";
  ...
  componentDidMount() {
    DataService.getReviewByJobandCompany(this.props.match.params.id,this.props.match.params.id2).then((res) =>{
